...
- Cài đặt hệ điều hành Ubuntu 22.04 LTS sạch.
- Hạn chế sử dụng các phiên bản không phải LTS, vì chúng có thể gây lỗi khi cập nhật cPanel.
- Gói cần thiết:
