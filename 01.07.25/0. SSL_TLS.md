<!-- TOC --><a name="ssl-secure-sockets-layer-tls-transport-layer-security"></a>
   ...
   * [12. Thực hành ](#12-thc-hành)
      ...
      + [12.2 Cài đặt, cấu hình trên các Webserver ](#122-cài-t-cu-hình-trên-các-webserver)
         ...
         - [12.2.2 Nginx  ](#1222-nginx)
            ...
            * [Kiểm tra chứng chỉ ](#kim-tra-chng-ch)
         - [12.2.3 Tomcat ](#1223-tomcat)
		  ...
		  - [12.2.4 IIS ](#1224-iis)
			 * [Khởi tạo IIS, CSR ](#khi-to-iis-csr)
			 * [Cấu hình SSL ](#cu-hình-ssl)
			 * [Cấu hình HTTP Redirect, HSTS, OCSP Stapling, HTTP/2 ](#cu-hình-http-redirect-hsts-ocsp-stapling-http2)
	   + [12.3 Web Hosting Manager ](#123-web-hosting-manager)
		  - [12.3.1 Plesk ](#1231-plesk)
		  - [12.3.2 DirectAdmin ](#1232-directadmin)
		  - [12.3.3 Cpanel ](#1233-cpanel)
- [References](#references)
<!-- TOC end -->


<!-- TOC --><a name="1-tng-quan-ssltls"></a>
## 1. Tổng quan SSL/TLS
<!-- TOC --><a name="11-ssltls"></a>
### 1.1 SSL/TLS  
...
<!-- TOC --><a name="12-lch-s-phiên-bn"></a>
...
<!-- TOC --><a name="13-vai-trò-ca-ssl-trong-bo-mt-mng-https-email-vpn-vv"></a>
...
<!-- TOC --><a name="15-các-vn-khi-s-dng-ssltls"></a>
...
<!-- TOC --><a name="16-so-sánh-ssltls"></a>
### 1.6 So sánh SSL/TLS
...
<!-- TOC --><a name="2-cách-thc-hot-ng-ca-ssl"></a>
## 2. Cách thức hoạt động của SSL 
<!-- TOC --><a name="21-hot-ng-ca-ssltls"></a>
...
<!-- TOC --><a name="22-handshake-ssltls-cách-thit-lp-kt-ni-an-toàn"></a>
...
<!-- TOC --><a name="23-vai-trò-ca-khóa-công-khai-public-key-và-khóa-bí-mt-private-key"></a>
...
<!-- TOC --><a name="3-chng-ch-ssl-ssl-certificate"></a>
## 3. Chứng chỉ SSL (SSL Certificate)
<!-- TOC --><a name="31-khái-nim-và-mc-ích"></a>
...
<!-- TOC --><a name="32-các-loi-chng-ch-ssl"></a>
### 3.2 Các loại chứng chỉ SSL:
<!-- TOC --><a name="321-theo-cp-xác-thc"></a>
...
<!-- TOC --><a name="322-theo-phm-vi-bo-v"></a>
...
<!-- TOC --><a name="33-mã-hóa-trong-ssltls"></a>
...
<!-- TOC --><a name="331-mã-hóa-i-xng-symmetric-encryption"></a>
...
<!-- TOC --><a name="332-mã-hóa-bt-i-xng-asymmetric-encryption"></a>
...
<!-- TOC --><a name="333-thut-toán-trao-i-khóa-diffie-hellman-rsa-ecc"></a>
#### 3.3.3 Thuật toán trao đổi khóa (Diffie-Hellman, RSA, ECC).
<!-- TOC --><a name="dh-diffie-hellman"></a>
##### DH (Diffie-Hellman)
...
<!-- TOC --><a name="rsa-rivestshamiradleman"></a>
...
<!-- TOC --><a name="ecc-elliptic-curve-cryptography"></a>
...
<!-- TOC --><a name="334-các-thut-toán-mã-hóa-ph-bin-aes-3des-chacha20"></a>
...
<!-- TOC --><a name="34-cu-trúc-ca-chng-ch-ssl-common-name-san-issuer-validity-period"></a>
...
<!-- TOC --><a name="35-các-phng-pháp-xác-minh-chng-ch-ssl"></a>
...
<!-- TOC --><a name="4-nhà-cung-cp-chng-ch-ca-certificate-authority"></a>
## 4. Nhà cung cấp chứng chỉ (CA – Certificate Authority)
<!-- TOC --><a name="41-các-ca-uy-tín"></a>
### 4.1 Các CA uy tín:
...
<!-- TOC --><a name="42-c-ch-xác-minh-chng-ch"></a>
...
<!-- TOC --><a name="43-so-sánh-unhc-im"></a>
...
<!-- TOC --><a name="5-thành-phn-k-thut-cn-làm-rõ-hn"></a>
## 5. Thành phần kỹ thuật cần làm rõ hơn
<!-- TOC --><a name="51-public-key-private-key"></a>
...
<!-- TOC --><a name="52-csr-certificate-signing-request"></a>
...
<!-- TOC --><a name="53-các-nh-dng-file-chng-ch-x509"></a>
...
<!-- TOC --><a name="54-intermediate-ca-root-ca-và-chui-chng-ch-certificate-chain"></a>
...
<!-- TOC --><a name="6-cài-t-ssl-trên-máy-ch"></a>
...
<!-- TOC --><a name="61-trên-các-webserver"></a>
...
<!-- TOC --><a name="62-trên-các-web-hosting-control-panel"></a>
...
<!-- TOC --><a name="63-ssl-cho-tên-min-chính-và-subdomain"></a>
...
<!-- TOC --><a name="64-t-ng-gia-hn-auto-renewal-vi-lets-encrypt-certbot-acme"></a>
...
<!-- TOC --><a name="certbot-auto-renew"></a>
#### Certbot Auto Renew 
...
<!-- TOC --><a name="7-cu-hình-kim-tra-ssl"></a>
## 7. Cấu hình & kiểm tra SSL
<!-- TOC --><a name="71-cu-hình-https-redirect-301"></a>
...
<!-- TOC --><a name="72-cu-hình-hsts-ocsp-stapling-http2"></a>
### 7.2 Cấu hình HSTS, OCSP Stapling, HTTP/2
<!-- TOC --><a name="721-hsts"></a>
#### 7.2.1 HSTS 
...
- Cấu hình HSTS trên các WebServer 
	...
	- Apache Tomcat 
		...
		```
<!-- TOC --><a name="722-ocsp-stapling"></a>
#### 7.2.2 OCSP Stapling
...
<!-- TOC --><a name="73-công-c-kim-tra-ssl"></a>
### 7.3 Công cụ kiểm tra SSL:
<!-- TOC --><a name="731-ssl-labs"></a>
#### 7.3.1 SSL Labs
...
<!-- TOC --><a name="74-ánh-giá-bo-mt-ssl-rating"></a>
...
<!-- TOC --><a name="8-li-thng-gp"></a>
## 8. Lỗi thường gặp
<!-- TOC --><a name="81-mixed-content"></a>
### 8.1 Mixed content
...
<!-- TOC --><a name="82-err_cert_common_name_invalid"></a>
...
<!-- TOC --><a name="83-ssl-handshake-failure"></a>
...
<!-- TOC --><a name="84-expired-certificate"></a>
...
<!-- TOC --><a name="85-neterr_cert_authority_invalid-li-do-thiu-intermediate-ca-cert"></a>
...
<!-- TOC --><a name="9-giao-thc-chun-liên-quan"></a>
## 9. Giao thức & chuẩn liên quan
<!-- TOC --><a name="91-https-ssl-over-http"></a>
...
<!-- TOC --><a name="92-smtps-imaps-pop3s-ng-dng-ssl-trong-email"></a>
...
<!-- TOC --><a name="tng-quát-v-ssl-vi-mail"></a>
...
<!-- TOC --><a name="93-tls-versions-và-security-policy-ví-d-tt-tls-1011"></a>
...
<!-- TOC --><a name="10-xu-hng-trong-tng-lai"></a>
...
<!-- TOC --><a name="101-phát-trin-ca-tls-13-và-các-ci-tin-bo-mt"></a>
...
<!-- TOC --><a name="102-tích-hp-ssl-vi-các-công-ngh-mi-http3-quic"></a>
...
<!-- TOC --><a name="103-t-ng-hóa-chng-ch-ssl"></a>
...
<!-- TOC --><a name="11-ssl-và-lut-pháp-quy-nh"></a>
## 11. SSL và luật pháp – Quy định
<!-- TOC --><a name="111-quy-nh-v-bo-mt-thông-tin-pci-dss-gdpr-hipaa"></a>
...
<!-- TOC --><a name="112-vai-trò-ssl-trong-các-tiêu-chun-bo-mt-doanh-nghip"></a>
...
<!-- TOC --><a name="121-to-ssl"></a>
### 12.1 Tạo SSL
<!-- TOC --><a name="1211-self-signed-certificate"></a>
...
<!-- TOC --><a name="1212-zerossl-certificate"></a>
...
<!-- TOC --><a name="122-cài-t-cu-hình-trên-các-webserver"></a>
### 12.2 Cài đặt, cấu hình trên các Webserver 
<!-- TOC --><a name="1221-apache"></a>
#### 12.2.1 Apache  
<!-- TOC --><a name="cài-t"></a>
##### Cài đặt  
...
<!-- TOC --><a name="cài-t-chng-ch-ssl"></a>
##### Cài đặt chứng chỉ SSL 
...
<!-- TOC --><a name="cu-hình-http-redirect-hsts-ocsp-stapling-http2"></a>
...
<!-- TOC --><a name="1222-nginx"></a>
#### 12.2.2 Nginx  
<!-- TOC --><a name="cài-t-1"></a>
##### Cài đặt 
...
<!-- TOC --><a name="cu-hình-http-redirect-hsts-ocsp-stapling-http2-1"></a>
##### Cấu hình HTTP Redirect, HSTS, OCSP Stapling, HTTP/2 
- HTTP Redirect
	- Chỉnh sửa trong khối cấu hình server lắng nghe cổng 80 (HTTP), thêm:
	```
...
<!-- TOC --><a name="1223-tomcat"></a>
#### 12.2.3 Tomcat 
<!-- TOC --><a name="cài-t-tomcat"></a>
##### Cài đặt Tomcat
- Tạo user 
```
...
<!-- TOC --><a name="cu-hình-http-redirect-hsts-ocsp-stapling-http2-2"></a>
##### Cấu hình HTTP Redirect, HSTS, OCSP Stapling, HTTP/2 
- HTTP Redirect
...
<!-- TOC --><a name="1224-iis"></a>
#### 12.2.4 IIS 
<!-- TOC --><a name="khi-to-iis-csr"></a>
##### Khởi tạo IIS, CSR 
...
<!-- TOC --><a name="123-web-hosting-manager"></a>
### 12.3 Web Hosting Manager 

<!-- TOC --><a name="1231-plesk"></a>
#### 12.3.1 Plesk 
