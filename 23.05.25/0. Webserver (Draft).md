...
-  ApacheBench (ab), JMeter, Siege.
Trình bày ### 6.1  Công cụ đo lường hiệu suất (Apache Benchmark, JMeter).	
- seige 
...
```
- ![image](./images/a-78.png)
- Cấu hình 
```
sudo gvm-setup
```
- ![image](./images/a-79.png)
Qúa trình setup diễn ra khá lâu 
- ![image](./images/a-109.png)
- Kiểm tra cài đặt 
