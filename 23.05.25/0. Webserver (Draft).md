...
- PHP 
	...
	- Nginx
		...
		```
		- Thực hiện 
			- Uncomment khối nhập (entry block) các tập lệnh PHP vào FastCGI.
			- Uncomment dòng để bao gồm snippets/fastcgi-php.conf.
			- Uncomment dòng để bật fastcgi_pass và php8.1-fpm.sock.
			- Uncomment phần để từ chối tất cả quyền truy cập vào các tệp .htaccess của Apache.
