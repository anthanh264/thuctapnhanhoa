...
src_dir = r'C:\Users\an.nt\Documents\GitHub\thuctapnhanhoa\13.06.25\images'
dst_dir = r'C:\Users\an.nt\Documents\GitHub\thuctapnhanhoa\16.06.25\images'

# Tạo thư mục đích nếu chưa có
os.makedirs(dst_dir, exist_ok=True)

# Trích xuất danh sách ảnh từ file markdown
with open('SQL_SERVER.md', 'r', encoding='utf-8') as f:
    content = f.read()
