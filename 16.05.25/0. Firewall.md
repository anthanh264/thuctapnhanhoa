# Index
 - [Firewall](#firewall)
   - [1. Firewall trên Linux](#1-firewall-trn-linux)
     - [1.1. Tổng quan](#11-tng-quan)
     - [1.2. Yêu cầu cơ bản: ](#12-yu-cu-c-bn)
       - [1.2.1 iptables](#121-iptables)
       - [1.2.2 firewalld](#122-firewalld)
       - [1.2.3 ufw ](#123-ufw)
       - [1.2.4 csf ](#124-csf)
       - [1.2.5 apf ](#125-apf)
     - [1.3. Tìm hiểu: Cấu hình, sử dụng](#13-tm-hiu-cu-hnh-s-dng)
       - [1.3.1 iptables ](#131-iptables)
       - [1.3.2 firewalld ](#132-firewalld)
       - [1.3.3 ufw ](#133-ufw)
       - [1.3.4 csf](#134-csf)
       - [1.3.5 apf ](#135-apf)
     - [1.4. Thực hành](#14-thc-hnh)
       - [1.4.1 iptables ](#141-iptables)
       - [1.4.2 firewalld](#142-firewalld)
       - [1.4.3 ufw ](#143-ufw)
       - [1.4.4 csf  ](#144-csf)
       - [1.4.5 apf  ](#145-apf)
   - [2. Firewall trên Windows](#2-firewall-trn-windows)
     - [2.1. Tổng quan](#21-tng-quan)
     - [2.2. Yêu cầu cơ bản: ](#22-yu-cu-c-bn)
     - [2.3. Tìm hiểu: Cấu hình, sử dụng](#23-tm-hiu-cu-hnh-s-dng)
   - [3. So sánh](#3-so-snh)
