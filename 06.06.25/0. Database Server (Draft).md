...
```	
- Gía trị bind address từ `localhost' -> ip của máy chủ tương ứng 
systemctl restart mysql 

- Tạo user replica 
```
CREATE USER 'replicator'@'%' IDENTIFIED BY 'Qaz@123!@';
```
- Gán quyền user replica 
```
...
SHOW MASTER STATUS;
```
ghi nhớ 2 giá trị file, position 
...
CHANGE MASTER TO MASTER_HOST = '192.168.50.128', 
    ...
    MASTER_PASSWORD = ‘Qaz@123!@’, 
    MASTER_LOG_FILE = ‘mysql-bin.000011’, 
    MASTER_LOG_POS = 1791;
```

CHANGE MASTER TO MASTER_HOST='192.168.50.129',MASTER_USER='replicator', MASTER_PASSWORD='your_password', MASTER_LOG_FILE='mysql-bin.000002', MASTER_LOG_POS= 869;
- Master 1
