...
- [Tìm hiểu chung về Linux ](#tìm-hiu-chung-v-linux)
   ...
   * [5. Process trong Linux](#5-process-trong-linux)
      ...
      + [5.3 Các lệnh kiểm tra giám sát Processes](#53-các-lnh-kim-tra-giám-sát-processes)
         ...
         - [5.4 Quản lý tiền trình ](#54-qun-lý-tin-trình)
   ...
   * [7. Network File System (NFS)](#7-network-file-system-nfs)
      ...
      + [7.2 Cài đặt dịch vụ và Kết nối nfs client với nfs serer](#72-cài-t-dch-v-và-kt-ni-nfs-client-vi-nfs-serer)
         - [7.4 Trên máy host server ](#74-trên-máy-host-server)
         - [7.6 Kiểm tra kết quả mount](#76-kim-tra-kt-qu-mount)
...
<!-- TOC --><a name="tìm-hiu-chung-v-linux"></a>
# Tìm hiểu chung về Linux 
***
<!-- TOC --><a name="table-of-contents"></a>
## Table of Contents

- [Tìm hiểu chung về Linux](#tìm-hiểu-chung-về-linux)
  - [1. Tổng quan về Linux](#1.-tổng-quan-về-linux)
    - [1.1 Linux là gì](#1.1-linux-là-gì)
    - [1.2 Kiến trúc hệ thống Linux.](#1.2-kiến-trúc-hệ-thống-linux.)
      - [1.2.1 Kernel](#1.2.1-kernel)
      - [1.2.2. System Library](#1.2.2.-system-library)
      - [1.2.3 Shell](#1.2.3-shell)
      - [1.2.4 Hardware layer](#1.2.4-hardware-layer)
      - [1.2.5 System Utitlies](#1.2.5-system-utitlies)
    - [1.3 Các bản phân phối (distro) phổ biến.](#1.3-các-bản-phân-phối-(distro)-phổ-biến.)
      - [1.3.1 Debian Distro](#1.3.1-debian-distro)
      - [1.3.2 RedHat Distro](#1.3.2-redhat-distro)
      - [1.3.3 Slackware Distro](#1.3.3-slackware-distro)
  - [2. Quản lý người dùng và nhóm](#2.-quản-lý-người-dùng-và-nhóm)
    - [2.1 User](#2.1-user)
      - [2.1.1 Thêm user](#2.1.1-thêm-user)
      - [2.1.2 Sửa user](#2.1.2-sửa-user)
      - [2.1.3 Xoá user](#2.1.3-xoá-user)
    - [2.2 Group](#2.2-group)
      - [2.2.1 Tạo Group](#2.2.1-tạo-group)
      - [2.2.2 Sửa group](#2.2.2-sửa-group)
      - [2.2.3 Xoá group](#2.2.3-xoá-group)
    - [2.4 Quyền và chủ sử hữu trong Linux](#2.4-quyền-và-chủ-sử-hữu-trong-linux)
    - [2.1 Owner (Chủ sở hữu) trong Linux](#2.1-owner-(chủ-sở-hữu)-trong-linux)
    - [2.2 Quyền (Permissions) trên file/folder](#2.2-quyền-(permissions)-trên-file/folder)
  - [3. Các lệnh hữu ích khác](#3.-các-lệnh-hữu-ích-khác)
    - [3.1 Lệnh liên quan đến hệ thống](#3.1-lệnh-liên-quan-đến-hệ-thống)
    - [3.2 Lệnh thao tác trên tập tin](#3.2-lệnh-thao-tác-trên-tập-tin)
    - [3.2 Lệnh khi làm việc trên terminal](#3.2-lệnh-khi-làm-việc-trên-terminal)
    - [3.3 Lệnh quản lí hệ thống](#3.3-lệnh-quản-lí-hệ-thống)
    - [3.4 Các câu lệnh kiểm tra thông tin hệ thống (system information) trong Linux](#3.4-các-câu-lệnh-kiểm-tra-thông-tin-hệ-thống-(system-information)-trong-linux)
    - [3.5 Các lệnh Quản lý services và process trong Linux](#3.5-các-lệnh-quản-lý-services-và-process-trong-linux)
    - [3.6 Các lệnh liên quan tới tệp nén](#3.6-các-lệnh-liên-quan-tới-tệp-nén)
  - [4. Bộ soạn thảo trên linux: vi, nano](#4.-bộ-soạn-thảo-trên-linux:-vi,-nano)
    - [4.1 vi](#4.1-vi)
    - [4.2 Nano](#4.2-nano)
  - [5. Process trong Linux](#5.-process-trong-linux)
    - [5.1 Process](#5.1-process)
    - [5.2 Các trạng thái Process](#5.2-các-trạng-thái-process)
      - [5.2.1 Running or Runnable State (R)](#5.2.1-running-or-runnable-state-(r))
      - [5.2.2 Sleeping State: Interruptible (S) and Uninterruptible (D)](#5.2.2-sleeping-state:-interruptible-(s)-and-uninterruptible-(d))
      - [5.2.3 Stopped State (T)](#5.2.3-stopped-state-(t))
      - [5.2.4 Zombie State (Z)](#5.2.4-zombie-state-(z))
    - [5.3 Các lệnh kiểm tra giám sát Processes](#5.3-các-lệnh-kiểm-tra-giám-sát-processes)
      - [5.3.1 Lệnh ps](#5.3.1-lệnh-ps)
      - [5.3.2 Lệnh top](#5.3.2-lệnh-top)
      - [5.3.3 Lệnh htop](#5.3.3-lệnh-htop)
      - [5.3.3 Lệnh pgrep](#5.3.3-lệnh-pgrep)
      - [5.4 Quản lý tiền trình](#5.4-quản-lý-tiền-trình)
  - [6. Network trong Linux](#6.-network-trong-linux)
    - [6.1 Các khái niệm](#6.1-các-khái-niệm)
    - [6.2 Cấu hình mạng Linux](#6.2-cấu-hình-mạng-linux)
      - [6.2.1 Các file cấu hình Network](#6.2.1-các-file-cấu-hình-network)
      - [6.2.2 Các lệnh quản trị phổ biến](#6.2.2-các-lệnh-quản-trị-phổ-biến)
      - [6.2.3 Bảng định tuyến Routing Tables](#6.2.3-bảng-định-tuyến-routing-tables)
      - [6.2.4 Tường lửa Firewall (iptables)](#6.2.4-tường-lửa-firewall-(iptables))
    - [6.3 Sử dụng Netstat quản lý mạng trên Linux](#6.3-sử-dụng-netstat-quản-lý-mạng-trên-linux)
  - [7. Network File System (NFS)](#7.-network-file-system-(nfs))
    - [7.1 Tìm hiểu NFS server](#7.1-tìm-hiểu-nfs-server)
    - [7.2 Cài đặt dịch vụ và Kết nối nfs client với nfs serer](#7.2-cài-đặt-dịch-vụ-và-kết-nối-nfs-client-với-nfs-serer)
      - [7.4 Trên máy host server](#7.4-trên-máy-host-server)
      - [7.5 Cài đặt trên client](#7.5-cài-đặt-trên-client)
      - [7.6 Kiểm tra kết quả mount](#7.6-kiểm-tra-kết-quả-mount)
  - [8. Logical Volume Manager](#8.-logical-volume-manager)
    - [8.1 Tìm hiểu về LVM](#8.1-tìm-hiểu-về-lvm)
    - [8.2 Sử dụng LVM](#8.2-sử-dụng-lvm)
      - [8.2.1 Tạo partition](#8.2.1-tạo-partition)
      - [8.2.2 Tạo physical volume](#8.2.2-tạo-physical-volume)
      - [8.2.3 Tạo volume group.](#8.2.3-tạo-volume-group.)
      - [8.2.4 Tạo logical volume.](#8.2.4-tạo-logical-volume.)
      - [8.2.5 Tạo filesystem trên logical volume.](#8.2.5-tạo-filesystem-trên-logical-volume.)
      - [8.2.6 Chỉnh sửa fstab để tự động mount phân vùng.](#8.2.6-chỉnh-sửa-fstab-để-tự-động-mount-phân-vùng.)
      - [8.2.7 Mở rộng logical volume.](#8.2.7-mở-rộng-logical-volume.)
      - [8.2.8 Thêm ổ cứng mở rộng logical volume.](#8.2.8-thêm-ổ-cứng-mở-rộng-logical-volume.)
      - [8.2.9 Out/ thay thế 1 ổ cứng ra khỏi hệ thống LVM](#8.2.9-out/-thay-thế-1-ổ-cứng-ra-khỏi-hệ-thống-lvm)
      - [8.2.10 Xóa logical volume, xóa volume group, xóa physical volume](#8.2.10-xóa-logical-volume,-xóa-volume-group,-xóa-physical-volume)
  - [References](#references)

<!-- TOC --><a name="1-tng-quan-v-linux"></a>
## 1. Tổng quan về Linux
<!-- TOC --><a name="11-linux-là-gì"></a>
### 1.1 Linux là gì
...
<!-- TOC --><a name="12-kin-trúc-h-thng-linux"></a>
...
<!-- TOC --><a name="122-system-library"></a>
...
<!-- TOC --><a name="124-hardware-layer"></a>
...
<!-- TOC --><a name="125-system-utitlies"></a>
...
<!-- TOC --><a name="13-các-bn-phân-phi-distro-ph-bin"></a>
...
<!-- TOC --><a name="131-debian-distro"></a>
#### 1.3.1 Debian Distro
...
<!-- TOC --><a name="132-redhat-distro"></a>
#### 1.3.2 RedHat Distro
...
<!-- TOC --><a name="133-slackware-distro"></a>
...
<!-- TOC --><a name="2-qun-lý-ngi-dùng-và-nhóm"></a>
...
<!-- TOC --><a name="223-xoá-group"></a>
#### 2.2.3 Xoá group 
- Để xóa group ta sử dụng lệnh “groupdel”.
	```
	groupdel [group_name]
	```
<!-- TOC --><a name="24-quyn-và-ch-s-hu-trong-linux"></a>
...
<!-- TOC --><a name="21-owner-ch-s-hu-trong-linux"></a>
...
<!-- TOC --><a name="22-quyn-permissions-trên-filefolder"></a>
...
<!-- TOC --><a name="3-các-lnh-hu-ích-khác"></a>
## 3. Các lệnh hữu ích khác
<!-- TOC --><a name="31-lnh-liên-quan-n-h-thng"></a>
...
```
<!-- TOC --><a name="32-lnh-thao-tác-trên-tp-tin"></a>
...
```
<!-- TOC --><a name="32-lnh-khi-làm-vic-trên-terminal"></a>
...
<!-- TOC --><a name="33-lnh-qun-lí-h-thng"></a>
...
```
<!-- TOC --><a name="34-các-câu-lnh-kim-tra-thông-tin-h-thng-system-information-trong-linux"></a>
...
<!-- TOC --><a name="35-các-lnh-qun-lý-services-và-process-trong-linux"></a>
...
<!-- TOC --><a name="36-các-lnh-liên-quan-ti-tp-nén"></a>
...
<!-- TOC --><a name="4-b-son-tho-trên-linux-vi-nano"></a>
...
<!-- TOC --><a name="5-process-trong-linux"></a>
## 5. Process trong Linux
<!-- TOC --><a name="51-process"></a>
### 5.1 Process 
...
<!-- TOC --><a name="52-các-trng-thái-process"></a>
...
<!-- TOC --><a name="521-running-or-runnable-state-r"></a>
...
<!-- TOC --><a name="522-sleeping-state-interruptible-s-and-uninterruptible-d"></a>
...
<!-- TOC --><a name="523-stopped-state-t"></a>
...
<!-- TOC --><a name="524-zombie-state-z"></a>
...
<!-- TOC --><a name="53-các-lnh-kim-tra-giám-sát-processes"></a>
### 5.3 Các lệnh kiểm tra giám sát Processes
<!-- TOC --><a name="531-lnh-ps"></a>
#### 5.3.1 Lệnh ps 
...
<!-- TOC --><a name="54-qun-lý-tin-trình"></a>
...
<!-- TOC --><a name="62-cu-hình-mng-linux"></a>
### 6.2 Cấu hình mạng Linux 
<!-- TOC --><a name="621-các-file-cu-hình-network"></a>
...
<!-- TOC --><a name="622-các-lnh-qun-tr-ph-bin"></a>
...
<!-- TOC --><a name="623-bng-nh-tuyn-routing-tables"></a>
...
<!-- TOC --><a name="624-tng-la-firewall-iptables"></a>
...
<!-- TOC --><a name="63-s-dng-netstat-qun-lý-mng-trên-linux"></a>
...
<!-- TOC --><a name="7-network-file-system-nfs"></a>
## 7. Network File System (NFS)
<!-- TOC --><a name="71-tìm-hiu-nfs-server"></a>
...
<!-- TOC --><a name="72-cài-t-dch-v-và-kt-ni-nfs-client-vi-nfs-serer"></a>
...
<!-- TOC --><a name="74-trên-máy-host-server"></a>
#### 7.4 Trên máy host server 
...
<!-- TOC --><a name="76-kim-tra-kt-qu-mount"></a>
#### 7.6 Kiểm tra kết quả mount
...
<!-- TOC --><a name="8-logical-volume-manager"></a>
## 8. Logical Volume Manager
<!-- TOC --><a name="81-tìm-hiu-v-lvm"></a>
### 8.1 Tìm hiểu về LVM 
...
<!-- TOC --><a name="822-to-physical-volume"></a>
...
<!-- TOC --><a name="823-to-volume-group"></a>
...
<!-- TOC --><a name="824-to-logical-volume"></a>
...
<!-- TOC --><a name="825-to-filesystem-trên-logical-volume"></a>
...
<!-- TOC --><a name="826-chnh-sa-fstab-t-ng-mount-phân-vùng"></a>
...
<!-- TOC --><a name="827-m-rng-logical-volume"></a>
...
<!-- TOC --><a name="828-thêm-cng-m-rng-logical-volume"></a>
...
<!-- TOC --><a name="829-out-thay-th-1-cng-ra-khi-h-thng-lvm"></a>
...
<!-- TOC --><a name="8210-xóa-logical-volume-xóa-volume-group-xóa-physical-volume"></a>
