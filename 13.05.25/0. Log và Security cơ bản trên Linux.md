...
- Syslog-ng Network Logging  
	- Khi nói đến việc thu thập thông báo nhật ký qua mạng, syslog-ng có ba chế độ hoạt động:
		* Chế độ máy khách: syslog-ng thu thập nhật ký từ máy khách và gửi trực tiếp đến máy chủ trung tâm hoặc thông qua một rơle.
		* Chế độ rơle: syslog-ng thu thập nhật ký từ máy khách qua mạng và gửi trực tiếp đến máy chủ trung tâm hoặc thông qua một rơle khác.
		* Chế độ máy chủ: syslog-ng thu thập nhật ký từ máy khách và/hoặc rơle và lưu trữ chúng cục bộ hoặc trong trình điều khiển đích không phải syslog.
...
3. https://betterstack.com/community/guides/logging/how-to-manage-log-files-with-logrotate-on-ubuntu-20-04/#the-necessity-of-log-rotation
4. https://hocvps.com/logrotate/	
5. https://linuxconfig.org/logrotate
6. https://wiki.nhanhoa.com/kb/tim-hieu-ve-log-syslog-rsyslog-tren-linux/
7. https://en.wikipedia.org/wiki/Rsyslog
8. https://syslog-ng.github.io/admin-guide/010_Introduction_to_syslog-ng/000_What_syslog-ng_is
9. https://www.syslog-ng.com/community/b/blog/posts/syslog-ng-101-part-4-configuration-and-testing
10. https://medium.com/@jayantgulati5/how-to-secure-linux-systems-ac6d0228d853
11. https://daily.dev/blog/linux-user-groups-and-permissions-guide
