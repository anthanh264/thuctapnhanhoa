...
- Sinh chứng chỉ tự ký 
	...
	Ở bước này, bạn sẽ được hỏi điền thông tin như quốc gia, tỉnh, tên miền (Common Name).
	Ví dụ: Common Name = annth.io.vn
...
2. Chuẩn bị Certificate Signing Request (CSR)
Có hai lựa chọn:
- Nếu để ZeroSSL tự tạo CSR, bỏ qua bước này và chọn "Auto-Generate CSR" trong giao diện.
- Nếu muốn tự tạo CSR để tái sử dụng:
openssl req -new -newkey rsa:2048 -nodes -keyout domain.key -out domain.csr


File .key là khóa bí mật, .csr là yêu cầu chứng thực. Cần ghi nhớ Common Name khớp với tên miền chính.

3. Tạo chứng chỉ trong ZeroSSL
...
- Tương tự với Host Manager:
sudo nano /opt/tomcat/webapps/host-manager/META-INF/context.xml
s-125
- Tạo systemd services 

Tìm đường dẫn tới JDK 
